...
class TextPreProccessing():
    ...
    def __init__(self, text, language= "english"):
        ...
        Argumentos:
            text (str/list): El texto a preprocesar. Puede ser una cadena o una lista de cadenas.
            language (str): El idioma del texto (opcional). Por defecto es "english".
        """
        self.text = text
    ...
    def join_text(self):
        ...
        Devuelve:
            str: El texto como una única cadena.
        """
        # Si es un conjunto de textos se unen en uno solo
        if (type(self.text) != str):
            self.text = ' '.join(str(self.text))
        return self.text
    ...
    def clean_structure(self):
        ...
        Devuelve:
            str: El texto con formato limpio.
        """
    ...
    def stop_words(self):
        ...
        Devuelve:
            set: Un conjunto de palabras comunes en el idioma especificado.
        """
    ...
    def lematize_text(self):
        ...
        Devuelve:
            str: El texto lematizado como una cadena.
        """
    ...
    def clean_text(self):
        ...
        Devuelve:
            str: El texto limpio y preprocesado como una cadena.
        """
    ...
    def extract_emojis(self):
        ...
        Devuelve:
            list/None: Una lista con los emojis encontrados en el texto o None si no se encontraron emojis.
        """
...
class ExploreTexts():
    ...
    def __init__(self, df):
        ...
        Argumentos:
            df (DataFrame): El DataFrame a explorar.
        """
        self.df = df
    ...
    def join_text(self, column):
        ...
        Argumentos:
            column (str): La columna del DataFrame que contiene las cadenas a unir.
        Devuelve:
            str: Una única cadena con todas las cadenas de la columna unidas.
        """
    ...
    def wordcloud_draw(self, column, background_color, mask = None):
        ...
        Argumentos:
            column (str): La columna del DataFrame que contiene el texto para generar la nube de palabras.
            background_color (str): El color de fondo de la nube de palabras.
            mask (ndarray): Una máscara para dar forma a la nube de palabras (opcional).
                             Por defecto es None (sin forma).
        Devuelve:
            WordCloud: Un objeto WordCloud con la nube de palabras generada.
        """
    ...
    def words_ranking(self, column, n):
        ...
        Argumentos:
            column (str): La columna del DataFrame que contiene el texto para generar el ranking.
            n (int): El número de palabras a incluir en el ranking.
        Devuelve:
            DataFrame: Un nuevo DataFrame con las n palabras más comunes y sus frecuencias.
        """
    ...
    def emoji_ranking(self, column):
        ...
        Argumentos:
            column (str): La columna del DataFrame que contiene los emojis para generar el ranking.
        Devuelve:
            DataFrame: Un nuevo DataFrame con los emojis más comunes y sus frecuencias.
        """
